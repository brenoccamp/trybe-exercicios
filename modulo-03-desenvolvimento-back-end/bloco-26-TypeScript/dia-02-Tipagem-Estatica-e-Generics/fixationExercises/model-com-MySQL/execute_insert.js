...
var main = function () { return __awaiter(void 0, void 0, void 0, function () {
    var title, price, author, isbn, result, dataInserted, insertId;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                title = readline.question('Digite o nome do livro');
                ...
                return [4 /*yield*/, connection_1["default"].execute('INSERT INTO books (title, price, author, isbn) VALUES (?, ?, ?, ?)', [title, price, author, isbn])];
            case 1:
                result = _a.sent();
